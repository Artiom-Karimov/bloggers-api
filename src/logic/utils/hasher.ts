...
export default class Hasher {
    ...
    public static async check(password:string, hashPair:HashPair): Promise<boolean> {
        return await bcrypt.compare(Hasher.applySalt(password,hashPair.salt),hashPair.hash)
    }
